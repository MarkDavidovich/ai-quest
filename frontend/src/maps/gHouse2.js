    ...
    .map((_, row) =>
      Array(10)
        ...
        .map((_, col) => {
          ...
          if (row === 1 && col === 1) return "houseClayPot";
          if (row === 1 && col === 6) return "housePotion";
          if (row === 2 && col === 2) return "houseTable";
          if (row === 2 && col === 3) return "houseChair";
          if (row === 3 && col === 7) return "houseBucket";
          if (row === 4 && col === 6) return "npc";
          if (row === 5 && col === 2) return "houseBox";
          if (row === 5 && col === 7) return "houseClayPot";
          if (row === 6 && col === 1) return "houseBox";
